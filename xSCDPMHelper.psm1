...
Import-LocalizedData LocalizedData -filename xSCDPM.strings.psd1 -ErrorAction SilentlyContinue
Import-LocalizedData USLocalizedData -filename xSCDPM.strings.psd1 -UICulture en-US -ErrorAction SilentlyContinue
